...
public final class GetForumBroadcastListReqIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<GetForumBroadcastListReqIdl> {
        ...
        public GetForumBroadcastListReqIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new GetForumBroadcastListReqIdl(this, z, null) : (GetForumBroadcastListReqIdl) invokeZ.objValue;
        }
    }
