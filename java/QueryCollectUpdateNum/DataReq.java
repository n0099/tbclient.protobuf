...
public final class DataReq extends Message {
    ...
    public static final Integer DEFAULT_COLLECT_MARK;
    ...
    public final CommonReq f79832common;
    ...
    public static final class Builder extends Message.Builder<DataReq> {
        ...
        public Builder(DataReq dataReq) {
            ...
            this.f79833common = dataReq.f79832common;
        }
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(612660325, "Ltbclient/QueryCollectUpdateNum/DataReq;")) != null) {
    ...
    public DataReq(Builder builder, boolean z) {
        ...
        if (z) {
            ...
            this.f79832common = builder.f79833common;
            return;
        }
