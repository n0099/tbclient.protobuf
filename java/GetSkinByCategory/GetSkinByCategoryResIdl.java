...
public final class GetSkinByCategoryResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<GetSkinByCategoryResIdl> {
        ...
        public Builder(GetSkinByCategoryResIdl getSkinByCategoryResIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {getSkinByCategoryResIdl};
        ...
        public GetSkinByCategoryResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new GetSkinByCategoryResIdl(this, z, null) : (GetSkinByCategoryResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ GetSkinByCategoryResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GetSkinByCategoryResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
