...
public final class ThemeRecommand extends Message {
    ...
    public static final class Builder extends Message.Builder<ThemeRecommand> {
        ...
        public ThemeRecommand build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new ThemeRecommand(this, z, null) : (ThemeRecommand) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ ThemeRecommand(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
