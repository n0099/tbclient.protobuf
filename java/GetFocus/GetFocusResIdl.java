...
public final class GetFocusResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<GetFocusResIdl> {
        ...
        public GetFocusResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new GetFocusResIdl(this, z, null) : (GetFocusResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ GetFocusResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
