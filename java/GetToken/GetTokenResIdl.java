...
public final class GetTokenResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<GetTokenResIdl> {
        ...
        public GetTokenResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new GetTokenResIdl(this, z, null) : (GetTokenResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ GetTokenResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
