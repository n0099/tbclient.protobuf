...
public final class CategoryList extends Message {
    ...
    private CategoryList(Builder builder, boolean z) {
        ...
        if (z) {
            ...
            if (builder.category_game_list == null) {
                this.category_game_list = DEFAULT_CATEGORY_GAME_LIST;
            } else {
                this.category_game_list = immutableCopyOf(builder.category_game_list);
            }
    ...
    public final class Builder extends Message.Builder<CategoryList> {
        ...
        public Builder(CategoryList categoryList) {
            ...
            if (categoryList != null) {
                ...
                this.category_game_list = CategoryList.copyOf(categoryList.category_game_list);
