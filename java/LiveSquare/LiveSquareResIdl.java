...
public final class LiveSquareResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<LiveSquareResIdl> {
        ...
        public Builder(LiveSquareResIdl liveSquareResIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {liveSquareResIdl};
        ...
        public LiveSquareResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new LiveSquareResIdl(this, z, null) : (LiveSquareResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ LiveSquareResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LiveSquareResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
