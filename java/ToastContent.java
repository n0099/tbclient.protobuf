...
public final class ToastContent extends Message {
    ...
    public static final Integer DEFAULT_HAS_COLOR;
    ...
    public static final class Builder extends Message.Builder<ToastContent> {
        ...
        public ToastContent build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new ToastContent(this, z, null) : (ToastContent) invokeZ.objValue;
        }
    }
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(-2051444353, "Ltbclient/ToastContent;")) != null) {
    ...
    public /* synthetic */ ToastContent(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
