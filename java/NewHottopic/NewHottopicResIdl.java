...
public final class NewHottopicResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<NewHottopicResIdl> {
        ...
        public Builder(NewHottopicResIdl newHottopicResIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {newHottopicResIdl};
        ...
        public NewHottopicResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new NewHottopicResIdl(this, z, null) : (NewHottopicResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ NewHottopicResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NewHottopicResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
