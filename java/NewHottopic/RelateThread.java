...
public final class RelateThread extends Message {
    ...
    public static final List<TopicThread> DEFAULT_THREAD_LIST;
    ...
    public static final class Builder extends Message.Builder<RelateThread> {
        ...
        public RelateThread build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new RelateThread(this, z, null) : (RelateThread) invokeZ.objValue;
        }
    }
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(863969153, "Ltbclient/NewHottopic/RelateThread;")) != null) {
    ...
    public /* synthetic */ RelateThread(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
