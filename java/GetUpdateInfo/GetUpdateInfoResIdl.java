...
public final class GetUpdateInfoResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<GetUpdateInfoResIdl> {
        ...
        public Builder(GetUpdateInfoResIdl getUpdateInfoResIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {getUpdateInfoResIdl};
        ...
        public GetUpdateInfoResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new GetUpdateInfoResIdl(this, z, null) : (GetUpdateInfoResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ GetUpdateInfoResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GetUpdateInfoResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
