...
public final class PbPresentList extends Message {
    ...
    public static final class Builder extends Message.Builder<PbPresentList> {
        ...
        public PbPresentList build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new PbPresentList(this, z, null) : (PbPresentList) invokeZ.objValue;
        }
    }
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(-503417378, "Ltbclient/PbPresentList;")) != null) {
    ...
    public /* synthetic */ PbPresentList(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
