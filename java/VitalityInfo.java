...
public final class VitalityInfo extends Message {
    ...
    public static final class Builder extends Message.Builder<VitalityInfo> {
        ...
        public VitalityInfo build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new VitalityInfo(this, z, null) : (VitalityInfo) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ VitalityInfo(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
