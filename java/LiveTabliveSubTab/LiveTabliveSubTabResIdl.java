...
public final class LiveTabliveSubTabResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<LiveTabliveSubTabResIdl> {
        ...
        public Builder(LiveTabliveSubTabResIdl liveTabliveSubTabResIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {liveTabliveSubTabResIdl};
        ...
        public LiveTabliveSubTabResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new LiveTabliveSubTabResIdl(this, z, null) : (LiveTabliveSubTabResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ LiveTabliveSubTabResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LiveTabliveSubTabResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
