...
public final class FinanceTabItems extends Message {
    ...
    public static final class Builder extends Message.Builder<FinanceTabItems> {
        ...
        public FinanceTabItems build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new FinanceTabItems(this, z, null) : (FinanceTabItems) invokeZ.objValue;
        }
    }
