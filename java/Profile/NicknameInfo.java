...
public final class NicknameInfo extends Message {
    ...
    public static final Integer DEFAULT_LEFT_DAYS;
    ...
    public static final class Builder extends Message.Builder<NicknameInfo> {
        ...
        public NicknameInfo build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new NicknameInfo(this, z, null) : (NicknameInfo) invokeZ.objValue;
        }
    }
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(-1334358833, "Ltbclient/Profile/NicknameInfo;")) != null) {
    ...
    public /* synthetic */ NicknameInfo(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
