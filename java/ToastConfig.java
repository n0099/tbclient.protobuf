...
public final class ToastConfig extends Message {
    ...
    public static final class Builder extends Message.Builder<ToastConfig> {
        ...
        public ToastConfig build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new ToastConfig(this, z, null) : (ToastConfig) invokeZ.objValue;
        }
    }
