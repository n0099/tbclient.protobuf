...
public final class TestingGame extends Message {
    ...
    /* synthetic */ TestingGame(Builder builder, boolean z, TestingGame testingGame) {
        this(builder, z);
    }

    private TestingGame(Builder builder, boolean z) {
        super(builder);
        if (z) {
    ...
    public final class Builder extends Message.Builder<TestingGame> {
        ...
        public Builder(TestingGame testingGame) {
            super(testingGame);
            if (testingGame != null) {
                this.today = TestingGame.copyOf(testingGame.today);
                this.tomorrow = TestingGame.copyOf(testingGame.tomorrow);
                this.future = TestingGame.copyOf(testingGame.future);
            }
        }

        /* JADX DEBUG: Method merged with bridge method */
        @Override // com.squareup.wire.Message.Builder
        public TestingGame build(boolean z) {
            return new TestingGame(this, z, null);
        }
    }
}
