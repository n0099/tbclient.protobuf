...
public final class ShareReqIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<ShareReqIdl> {
        ...
        public ShareReqIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new ShareReqIdl(this, z, null) : (ShareReqIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ ShareReqIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
