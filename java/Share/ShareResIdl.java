...
public final class ShareResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<ShareResIdl> {
        ...
        public ShareResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new ShareResIdl(this, z, null) : (ShareResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ ShareResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
