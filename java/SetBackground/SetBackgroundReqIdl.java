...
public final class SetBackgroundReqIdl extends Message {
    ...
    /* synthetic */ SetBackgroundReqIdl(Builder builder, boolean z, SetBackgroundReqIdl setBackgroundReqIdl) {
        this(builder, z);
    }

    private SetBackgroundReqIdl(Builder builder, boolean z) {
        super(builder);
        if (z) {
    ...
    public static final class Builder extends Message.Builder<SetBackgroundReqIdl> {
        ...
        public SetBackgroundReqIdl build(boolean z) {
            return new SetBackgroundReqIdl(this, z, null);
        }
    }
}
