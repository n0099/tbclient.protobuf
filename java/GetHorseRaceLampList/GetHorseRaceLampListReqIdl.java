...
public final class GetHorseRaceLampListReqIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<GetHorseRaceLampListReqIdl> {
        ...
        public Builder(GetHorseRaceLampListReqIdl getHorseRaceLampListReqIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {getHorseRaceLampListReqIdl};
        ...
        public GetHorseRaceLampListReqIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new GetHorseRaceLampListReqIdl(this, z, null) : (GetHorseRaceLampListReqIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ GetHorseRaceLampListReqIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GetHorseRaceLampListReqIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
