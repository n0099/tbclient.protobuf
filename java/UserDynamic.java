...
public final class UserDynamic extends Message {
    ...
    public static final class Builder extends Message.Builder<UserDynamic> {
        ...
        public UserDynamic build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new UserDynamic(this, z, null) : (UserDynamic) invokeZ.objValue;
        }
    }
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(-864024911, "Ltbclient/UserDynamic;")) != null) {
        ...
        DEFAULT_CONCERNED_USER_LIST = Collections.emptyList();
    }

    public /* synthetic */ UserDynamic(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
