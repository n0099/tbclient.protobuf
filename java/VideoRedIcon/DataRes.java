...
public final class DataRes extends Message {
    ...
    public static final List<RedIcon> DEFAULT_RED_ICON_LIST;
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(1512277563, "Ltbclient/VideoRedIcon/DataRes;")) != null) {
        ...
        DEFAULT_RED_ICON_LIST = Collections.emptyList();
    }
    ...
    public DataRes(Builder builder, boolean z) {
        ...
        if (z) {
            List list = builder.red_icon_list;
            if (list == null) {
