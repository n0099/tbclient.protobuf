...
public final class PresentNumInfo extends Message {
    ...
    public static final class Builder extends Message.Builder<PresentNumInfo> {
        ...
        public PresentNumInfo build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new PresentNumInfo(this, z, null) : (PresentNumInfo) invokeZ.objValue;
        }
    }
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(696405837, "Ltbclient/GetGiftList/PresentNumInfo;")) != null) {
    ...
    public /* synthetic */ PresentNumInfo(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
