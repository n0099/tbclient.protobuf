...
public final class UrlTitle extends Message {
    ...
    public static final class Builder extends Message.Builder<UrlTitle> {
        ...
        public UrlTitle build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new UrlTitle(this, z, null) : (UrlTitle) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ UrlTitle(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
