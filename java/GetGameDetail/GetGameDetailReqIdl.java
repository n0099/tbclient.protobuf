...
public final class GetGameDetailReqIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<GetGameDetailReqIdl> {
        ...
        public Builder(GetGameDetailReqIdl getGameDetailReqIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {getGameDetailReqIdl};
        ...
        public GetGameDetailReqIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new GetGameDetailReqIdl(this, z, null) : (GetGameDetailReqIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ GetGameDetailReqIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GetGameDetailReqIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
