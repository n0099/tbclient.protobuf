...
public final class GetGameDetailResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<GetGameDetailResIdl> {
        ...
        public Builder(GetGameDetailResIdl getGameDetailResIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {getGameDetailResIdl};
        ...
        public GetGameDetailResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new GetGameDetailResIdl(this, z, null) : (GetGameDetailResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ GetGameDetailResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GetGameDetailResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
