...
public final class SendFreeGiftResIdl extends Message {
    ...
    /* synthetic */ SendFreeGiftResIdl(Builder builder, boolean z, SendFreeGiftResIdl sendFreeGiftResIdl) {
        this(builder, z);
    }

    private SendFreeGiftResIdl(Builder builder, boolean z) {
        super(builder);
        if (z) {
    ...
    public static final class Builder extends Message.Builder<SendFreeGiftResIdl> {
        ...
        public SendFreeGiftResIdl build(boolean z) {
            return new SendFreeGiftResIdl(this, z, null);
        }
    }
}
