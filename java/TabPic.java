...
public final class TabPic extends Message {
    ...
    public static final class Builder extends Message.Builder<TabPic> {
        ...
        public TabPic build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new TabPic(this, z, null) : (TabPic) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ TabPic(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
