...
public final class DataRes extends Message {
    ...
    public static final Integer DEFAULT_IS_FOLLOW_DYNC;
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(794294415, "Ltbclient/FollowDync/DataRes;")) != null) {
            Interceptable interceptable = invokeClinit.interceptor;
            if (interceptable != null) {
                $ic = interceptable;
            }
            if ((invokeClinit.flags & 1) != 0) {
                classClinitInterceptable.invokePostClinit(794294415, "Ltbclient/FollowDync/DataRes;");
                return;
            }
        }
        DEFAULT_THREAD_LIST = Collections.emptyList();
        DEFAULT_HAS_MORE = 0;
        DEFAULT_IS_FOLLOW_DYNC = 0;
    }
    ...
    public DataRes(Builder builder, boolean z) {
        ...
        if (z) {
            ...
            Integer num2 = builder.is_follow_dync;
            if (num2 == null) {
                this.is_follow_dync = DEFAULT_IS_FOLLOW_DYNC;
                return;
            } else {
                this.is_follow_dync = num2;
                return;
            }
        }
