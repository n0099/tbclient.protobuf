...
public final class GetSkinListResIdl extends Message {
    ...
    /* synthetic */ GetSkinListResIdl(Builder builder, boolean z, GetSkinListResIdl getSkinListResIdl) {
        this(builder, z);
    }

    private GetSkinListResIdl(Builder builder, boolean z) {
        super(builder);
        if (z) {
    ...
    public static final class Builder extends Message.Builder<GetSkinListResIdl> {
        ...
        public GetSkinListResIdl build(boolean z) {
            return new GetSkinListResIdl(this, z, null);
        }
    }
}
