...
public final class Hong extends Message {
    ...
    public static final class Builder extends Message.Builder<Hong> {
        ...
        public Hong build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new Hong(this, z, null) : (Hong) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ Hong(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
