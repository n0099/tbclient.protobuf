...
public final class DataReq extends Message {
    ...
    public final CommonReq f61312common;
    ...
    public static final class Builder extends Message.Builder<DataReq> {
        ...
        public Builder(DataReq dataReq) {
            ...
            this.f61313common = dataReq.f61312common;
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(1697652299, "Ltbclient/GetShoubaiThreadList/DataReq;")) != null) {
    ...
    public DataReq(Builder builder, boolean z) {
        ...
        if (z) {
            this.f61312common = builder.f61313common;
            Long l = builder.uid;
            if (l == null) {
