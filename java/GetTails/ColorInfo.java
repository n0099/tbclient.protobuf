...
public final class ColorInfo extends Message {
    ...
    public static final class Builder extends Message.Builder<ColorInfo> {
        ...
        public ColorInfo build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new ColorInfo(this, z, null) : (ColorInfo) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ ColorInfo(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
