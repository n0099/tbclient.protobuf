...
public final class GetSkinReqIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<GetSkinReqIdl> {
        ...
        public GetSkinReqIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new GetSkinReqIdl(this, z, null) : (GetSkinReqIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ GetSkinReqIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
