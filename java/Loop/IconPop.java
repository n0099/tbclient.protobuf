...
public final class IconPop extends Message {
    ...
    public static final Long DEFAULT_ICON_ID;
    ...
    public static final class Builder extends Message.Builder<IconPop> {
        ...
        public IconPop build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new IconPop(this, z, null) : (IconPop) invokeZ.objValue;
        }
    }
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(1487392420, "Ltbclient/Loop/IconPop;")) != null) {
    ...
    public /* synthetic */ IconPop(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
