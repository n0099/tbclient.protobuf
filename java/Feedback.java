...
public final class Feedback extends Message {
    ...
    public static final class Builder extends Message.Builder<Feedback> {
        ...
        public Feedback build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new Feedback(this, z, null) : (Feedback) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ Feedback(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
