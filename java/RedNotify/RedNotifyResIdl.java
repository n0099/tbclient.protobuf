...
public final class RedNotifyResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<RedNotifyResIdl> {
        ...
        public RedNotifyResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new RedNotifyResIdl(this, z, null) : (RedNotifyResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ RedNotifyResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RedNotifyResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
