...
public final class ResignRule extends Message {
    ...
    public static final class Builder extends Message.Builder<ResignRule> {
        ...
        public ResignRule build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new ResignRule(this, z, null) : (ResignRule) invokeZ.objValue;
        }
    }
