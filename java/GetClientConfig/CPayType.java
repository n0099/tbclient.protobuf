...
public final class CPayType extends Message {
    ...
    public static final class Builder extends Message.Builder<CPayType> {
        ...
        public CPayType build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new CPayType(this, z, null) : (CPayType) invokeZ.objValue;
        }
    }
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(-985363834, "Ltbclient/GetClientConfig/CPayType;")) != null) {
    ...
    public /* synthetic */ CPayType(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
