...
public final class ItemThemeColor extends Message {
    ...
    public static final class Builder extends Message.Builder<ItemThemeColor> {
        ...
        public ItemThemeColor build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new ItemThemeColor(this, z, null) : (ItemThemeColor) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ ItemThemeColor(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
