...
public final class ItemDetail extends Message {
    ...
    public static final class Builder extends Message.Builder<ItemDetail> {
        ...
        public ItemDetail build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new ItemDetail(this, z, null) : (ItemDetail) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ ItemDetail(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
