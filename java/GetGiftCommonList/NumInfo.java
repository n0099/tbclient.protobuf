...
public final class NumInfo extends Message {
    ...
    public static final class Builder extends Message.Builder<NumInfo> {
        ...
        public NumInfo build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new NumInfo(this, z, null) : (NumInfo) invokeZ.objValue;
        }
    }
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(1065041041, "Ltbclient/GetGiftCommonList/NumInfo;")) != null) {
    ...
    public /* synthetic */ NumInfo(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
