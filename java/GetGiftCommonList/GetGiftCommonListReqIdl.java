...
public final class GetGiftCommonListReqIdl extends Message {
    ...
    /* synthetic */ GetGiftCommonListReqIdl(Builder builder, boolean z, GetGiftCommonListReqIdl getGiftCommonListReqIdl) {
        this(builder, z);
    }

    private GetGiftCommonListReqIdl(Builder builder, boolean z) {
        super(builder);
        if (z) {
    ...
    /* loaded from: classes.dex */
    public final class Builder extends Message.Builder<GetGiftCommonListReqIdl> {
        public DataReq data;
        ...
        public GetGiftCommonListReqIdl build(boolean z) {
            return new GetGiftCommonListReqIdl(this, z, null);
        }
    }
}
