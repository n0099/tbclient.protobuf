...
public final class RankItem extends Message {
    ...
    public static final class Builder extends Message.Builder<RankItem> {
        ...
        public RankItem build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new RankItem(this, z, null) : (RankItem) invokeZ.objValue;
        }
    }
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(1934385918, "Ltbclient/GetGameDetailNew/RankItem;")) != null) {
    ...
    public /* synthetic */ RankItem(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
