...
public final class HotTopicItem extends Message {
    ...
    /* synthetic */ HotTopicItem(Builder builder, boolean z, HotTopicItem hotTopicItem) {
        this(builder, z);
    }

    private HotTopicItem(Builder builder, boolean z) {
        super(builder);
        if (z) {
            ...
            if (builder.topic_discuss_num == null) {
