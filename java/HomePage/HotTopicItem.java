...
public final class HotTopicItem extends Message {
    ...
    public static final class Builder extends Message.Builder<HotTopicItem> {
        ...
        public HotTopicItem build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new HotTopicItem(this, z, null) : (HotTopicItem) invokeZ.objValue;
        }
    }
