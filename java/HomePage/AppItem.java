...
public final class AppItem extends Message {
    ...
    public static final class Builder extends Message.Builder<AppItem> {
        ...
        public AppItem build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new AppItem(this, z, null) : (AppItem) invokeZ.objValue;
        }
    }
