...
public final class HotVideoItem extends Message {
    ...
    /* synthetic */ HotVideoItem(Builder builder, boolean z, HotVideoItem hotVideoItem) {
        this(builder, z);
    }

    private HotVideoItem(Builder builder, boolean z) {
        super(builder);
        if (z) {
            if (builder.tid == null) {
    ...
    public static final class Builder extends Message.Builder<HotVideoItem> {
        ...
        public HotVideoItem build(boolean z) {
            return new HotVideoItem(this, z, null);
        }
    }
}
