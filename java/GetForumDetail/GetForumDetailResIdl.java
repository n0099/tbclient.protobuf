...
public final class GetForumDetailResIdl extends Message {
    ...
    /* synthetic */ GetForumDetailResIdl(Builder builder, boolean z, GetForumDetailResIdl getForumDetailResIdl) {
        this(builder, z);
    }
    ...
    /* loaded from: classes.dex */
    public final class Builder extends Message.Builder<GetForumDetailResIdl> {
        public DataRes data;
        public Error error;
        ...
        public GetForumDetailResIdl build(boolean z) {
            return new GetForumDetailResIdl(this, z, null);
        }
    }
}
