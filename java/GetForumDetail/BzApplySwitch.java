...
public final class BzApplySwitch extends Message {
    ...
    public static final class Builder extends Message.Builder<BzApplySwitch> {
        ...
        public BzApplySwitch build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new BzApplySwitch(this, z, null) : (BzApplySwitch) invokeZ.objValue;
        }
    }
