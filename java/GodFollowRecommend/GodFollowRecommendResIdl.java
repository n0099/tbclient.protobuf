...
public final class GodFollowRecommendResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<GodFollowRecommendResIdl> {
        ...
        public Builder(GodFollowRecommendResIdl godFollowRecommendResIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {godFollowRecommendResIdl};
        ...
        public GodFollowRecommendResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new GodFollowRecommendResIdl(this, z, null) : (GodFollowRecommendResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ GodFollowRecommendResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GodFollowRecommendResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
