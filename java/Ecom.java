...
public final class Ecom extends Message {
    ...
    public static final Integer DEFAULT_IS_SELLER;
    ...
    public static final class Builder extends Message.Builder<Ecom> {
        ...
        public Ecom build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new Ecom(this, z, null) : (Ecom) invokeZ.objValue;
        }
    }
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(-1101275627, "Ltbclient/Ecom;")) != null) {
    ...
    public /* synthetic */ Ecom(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
