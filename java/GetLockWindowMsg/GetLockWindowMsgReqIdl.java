...
public final class GetLockWindowMsgReqIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<GetLockWindowMsgReqIdl> {
        ...
        public GetLockWindowMsgReqIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new GetLockWindowMsgReqIdl(this, z, null) : (GetLockWindowMsgReqIdl) invokeZ.objValue;
        }
    }
