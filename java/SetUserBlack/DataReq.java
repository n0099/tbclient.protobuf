...
public final class DataReq extends Message {
    ...
    public final CommonReq f63092common;
    @ProtoField(tag = 3)
    ...
    public static final class Builder extends Message.Builder<DataReq> {
        ...
        public Builder(DataReq dataReq) {
            ...
            this.f63093common = dataReq.f63092common;
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(1836431450, "Ltbclient/SetUserBlack/DataReq;")) != null) {
    ...
    public DataReq(Builder builder, boolean z) {
        ...
        if (z) {
            this.f63092common = builder.f63093common;
