...
public final class DanmuInfo extends Message {
    ...
    public static final class Builder extends Message.Builder<DanmuInfo> {
        ...
        public DanmuInfo build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new DanmuInfo(this, z, null) : (DanmuInfo) invokeZ.objValue;
        }
    }
