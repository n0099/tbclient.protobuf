...
public final class DataRes extends Message {
    ...
    public static final List<OfficialList> DEFAULT_OFFICIAL_LIST;
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(181673161, "Ltbclient/GetOfficialSwitch/DataRes;")) != null) {
        ...
        DEFAULT_OFFICIAL_LIST = Collections.emptyList();
    }
    ...
    public DataRes(Builder builder, boolean z) {
        ...
        if (z) {
            List list = builder.official_list;
            if (list == null) {
