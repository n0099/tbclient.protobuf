...
public final class VipInfo extends Message {
    ...
    public static final class Builder extends Message.Builder<VipInfo> {
        ...
        public VipInfo build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new VipInfo(this, z, null) : (VipInfo) invokeZ.objValue;
        }
    }
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(923224256, "Ltbclient/GetVipInfo/VipInfo;")) != null) {
    ...
    public /* synthetic */ VipInfo(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
