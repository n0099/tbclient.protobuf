...
public final class VipTaskItem extends Message {
    ...
    public static final class Builder extends Message.Builder<VipTaskItem> {
        ...
        public VipTaskItem build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new VipTaskItem(this, z, null) : (VipTaskItem) invokeZ.objValue;
        }
    }
