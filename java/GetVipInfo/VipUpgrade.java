...
public final class VipUpgrade extends Message {
    ...
    public static final class Builder extends Message.Builder<VipUpgrade> {
        ...
        public VipUpgrade build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new VipUpgrade(this, z, null) : (VipUpgrade) invokeZ.objValue;
        }
    }
