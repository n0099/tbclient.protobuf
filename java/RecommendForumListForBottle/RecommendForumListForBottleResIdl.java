...
public final class RecommendForumListForBottleResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<RecommendForumListForBottleResIdl> {
        ...
        public Builder(RecommendForumListForBottleResIdl recommendForumListForBottleResIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {recommendForumListForBottleResIdl};
        ...
        public RecommendForumListForBottleResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new RecommendForumListForBottleResIdl(this, z, null) : (RecommendForumListForBottleResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ RecommendForumListForBottleResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RecommendForumListForBottleResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
