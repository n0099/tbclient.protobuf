...
public final class GetGiftMyListResIdl extends Message {
    ...
    /* synthetic */ GetGiftMyListResIdl(Builder builder, boolean z, GetGiftMyListResIdl getGiftMyListResIdl) {
        this(builder, z);
    }
    ...
    /* loaded from: classes.dex */
    public final class Builder extends Message.Builder<GetGiftMyListResIdl> {
        public DataRes data;
        public Error error;
        ...
        public GetGiftMyListResIdl build(boolean z) {
            return new GetGiftMyListResIdl(this, z, null);
        }
    }
}
