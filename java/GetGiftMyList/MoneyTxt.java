...
public final class MoneyTxt extends Message {
    ...
    /* synthetic */ MoneyTxt(Builder builder, boolean z, MoneyTxt moneyTxt) {
        this(builder, z);
    }
    ...
    /* loaded from: classes.dex */
    public final class Builder extends Message.Builder<MoneyTxt> {
        public String txt;
        public String url;
        ...
        public MoneyTxt build(boolean z) {
            return new MoneyTxt(this, z, null);
        }
    }
}
