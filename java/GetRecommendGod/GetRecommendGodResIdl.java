...
public final class GetRecommendGodResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<GetRecommendGodResIdl> {
        ...
        public Builder(GetRecommendGodResIdl getRecommendGodResIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {getRecommendGodResIdl};
        ...
        public GetRecommendGodResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new GetRecommendGodResIdl(this, z, null) : (GetRecommendGodResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ GetRecommendGodResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GetRecommendGodResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
