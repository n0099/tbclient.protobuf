...
public final class LegoReqIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<LegoReqIdl> {
        ...
        public LegoReqIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new LegoReqIdl(this, z, null) : (LegoReqIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ LegoReqIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
