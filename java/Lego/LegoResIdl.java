...
public final class LegoResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<LegoResIdl> {
        ...
        public LegoResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new LegoResIdl(this, z, null) : (LegoResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ LegoResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
