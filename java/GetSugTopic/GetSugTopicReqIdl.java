...
public final class GetSugTopicReqIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<GetSugTopicReqIdl> {
        ...
        public GetSugTopicReqIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new GetSugTopicReqIdl(this, z, null) : (GetSugTopicReqIdl) invokeZ.objValue;
        }
    }
