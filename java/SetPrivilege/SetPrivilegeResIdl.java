...
public final class SetPrivilegeResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<SetPrivilegeResIdl> {
        ...
        public Builder(SetPrivilegeResIdl setPrivilegeResIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {setPrivilegeResIdl};
        ...
        public SetPrivilegeResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new SetPrivilegeResIdl(this, z, null) : (SetPrivilegeResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ SetPrivilegeResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SetPrivilegeResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
