...
public final class SmartAppListResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<SmartAppListResIdl> {
        ...
        public Builder(SmartAppListResIdl smartAppListResIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {smartAppListResIdl};
        ...
        public SmartAppListResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new SmartAppListResIdl(this, z, null) : (SmartAppListResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ SmartAppListResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SmartAppListResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
