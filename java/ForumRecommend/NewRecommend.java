...
public final class NewRecommend extends Message {
    ...
    public static final class Builder extends Message.Builder<NewRecommend> {
        ...
        public NewRecommend build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new NewRecommend(this, z, null) : (NewRecommend) invokeZ.objValue;
        }
    }
