...
public final class ThemeCarousel extends Message {
    ...
    public static final class Builder extends Message.Builder<ThemeCarousel> {
        ...
        public ThemeCarousel build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new ThemeCarousel(this, z, null) : (ThemeCarousel) invokeZ.objValue;
        }
    }
