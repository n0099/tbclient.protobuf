...
public final class PermissionList extends Message {
    ...
    public static final class Builder extends Message.Builder<PermissionList> {
        ...
        public PermissionList build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new PermissionList(this, z, null) : (PermissionList) invokeZ.objValue;
        }
    }
