...
public final class PassFriendResIdl extends Message {
    ...
    /* synthetic */ PassFriendResIdl(Builder builder, boolean z, PassFriendResIdl passFriendResIdl) {
        this(builder, z);
    }
    ...
    /* loaded from: classes.dex */
    public final class Builder extends Message.Builder<PassFriendResIdl> {
        public DataRes data;
        public Error error;
        ...
        public PassFriendResIdl build(boolean z) {
            return new PassFriendResIdl(this, z, null);
        }
    }
}
