...
public final class FinePbPageResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<FinePbPageResIdl> {
        ...
        public Builder(FinePbPageResIdl finePbPageResIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {finePbPageResIdl};
        ...
        public FinePbPageResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new FinePbPageResIdl(this, z, null) : (FinePbPageResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ FinePbPageResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FinePbPageResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
