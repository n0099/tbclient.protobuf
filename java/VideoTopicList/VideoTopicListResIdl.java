...
public final class VideoTopicListResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<VideoTopicListResIdl> {
        ...
        public Builder(VideoTopicListResIdl videoTopicListResIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {videoTopicListResIdl};
        ...
        public VideoTopicListResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new VideoTopicListResIdl(this, z, null) : (VideoTopicListResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ VideoTopicListResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public VideoTopicListResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
