...
public final class Calendar extends Message {
    ...
    public Calendar(Builder builder, boolean z) {
        super(builder);
        if (z) {
            Integer num = builder.f69383d;
            if (num == null) {
                this.f69382d = DEFAULT_D;
            } else {
                this.f69382d = num;
            }
