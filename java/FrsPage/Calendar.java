...
public final class Calendar extends Message {
    ...
    public Calendar(Builder builder, boolean z) {
        super(builder);
        if (z) {
            Integer num = builder.f69257d;
            if (num == null) {
                this.f69256d = DEFAULT_D;
            } else {
                this.f69256d = num;
            }
