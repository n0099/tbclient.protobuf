...
public final class StarSchedule extends Message {
    ...
    public static final class Builder extends Message.Builder<StarSchedule> {
        ...
        public StarSchedule build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new StarSchedule(this, z, null) : (StarSchedule) invokeZ.objValue;
        }
    }
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(1047179663, "Ltbclient/FrsPage/StarSchedule;")) != null) {
    ...
    public /* synthetic */ StarSchedule(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
