...
public final class PrivateForumShareinfo extends Message {
    ...
    public static final class Builder extends Message.Builder<PrivateForumShareinfo> {
        ...
        public PrivateForumShareinfo build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new PrivateForumShareinfo(this, z, null) : (PrivateForumShareinfo) invokeZ.objValue;
        }
    }
