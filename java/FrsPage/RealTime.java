...
public final class RealTime extends Message {
    ...
    public static final class Builder extends Message.Builder<RealTime> {
        ...
        public RealTime build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new RealTime(this, z, null) : (RealTime) invokeZ.objValue;
        }
    }
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(-243265075, "Ltbclient/FrsPage/RealTime;")) != null) {
    ...
    public /* synthetic */ RealTime(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
