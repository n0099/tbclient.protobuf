...
public final class ForumButton extends Message {
    ...
    public static final Integer DEFAULT_IS_BLUEV;
    ...
    public static final class Builder extends Message.Builder<ForumButton> {
        ...
        public ForumButton build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new ForumButton(this, z, null) : (ForumButton) invokeZ.objValue;
        }
    }
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(-1359266805, "Ltbclient/FrsPage/ForumButton;")) != null) {
    ...
    public /* synthetic */ ForumButton(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
