...
public final class ShowLiveSecondPageResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<ShowLiveSecondPageResIdl> {
        ...
        public Builder(ShowLiveSecondPageResIdl showLiveSecondPageResIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {showLiveSecondPageResIdl};
        ...
        public ShowLiveSecondPageResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new ShowLiveSecondPageResIdl(this, z, null) : (ShowLiveSecondPageResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ ShowLiveSecondPageResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ShowLiveSecondPageResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
