...
public final class NobilityTdou extends Message {
    ...
    public static final class Builder extends Message.Builder<NobilityTdou> {
        ...
        public NobilityTdou build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new NobilityTdou(this, z, null) : (NobilityTdou) invokeZ.objValue;
        }
    }
