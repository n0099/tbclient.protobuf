...
public final class ThreadList extends Message {
    ...
    public static final class Builder extends Message.Builder<ThreadList> {
        ...
        public ThreadList build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new ThreadList(this, z, null) : (ThreadList) invokeZ.objValue;
        }
    }
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(1212574111, "Ltbclient/GetRecommendForumData/ThreadList;")) != null) {
    ...
    public /* synthetic */ ThreadList(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
