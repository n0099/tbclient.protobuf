...
public final class ForumMenuResIdl extends Message {
    ...
    /* synthetic */ ForumMenuResIdl(Builder builder, boolean z, ForumMenuResIdl forumMenuResIdl) {
        this(builder, z);
    }
    ...
    /* loaded from: classes.dex */
    public final class Builder extends Message.Builder<ForumMenuResIdl> {
        public DataRes data;
        public Error error;
        ...
        public ForumMenuResIdl build(boolean z) {
            return new ForumMenuResIdl(this, z, null);
        }
    }
}
