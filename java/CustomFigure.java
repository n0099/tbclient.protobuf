...
public final class CustomFigure extends Message {
    ...
    public static final class Builder extends Message.Builder<CustomFigure> {
        ...
        public CustomFigure build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new CustomFigure(this, z, null) : (CustomFigure) invokeZ.objValue;
        }
    }
