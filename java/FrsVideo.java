...
public final class FrsVideo extends Message {
    ...
    public static final class Builder extends Message.Builder<FrsVideo> {
        ...
        public FrsVideo build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new FrsVideo(this, z, null) : (FrsVideo) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ FrsVideo(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
