...
public final class RealtimeResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<RealtimeResIdl> {
        ...
        public RealtimeResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new RealtimeResIdl(this, z, null) : (RealtimeResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ RealtimeResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
