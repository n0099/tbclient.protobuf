...
public final class ConsumeInfo extends Message {
    ...
    public static final class Builder extends Message.Builder<ConsumeInfo> {
        ...
        public ConsumeInfo build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new ConsumeInfo(this, z, null) : (ConsumeInfo) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ ConsumeInfo(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
