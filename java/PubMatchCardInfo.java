...
public final class PubMatchCardInfo extends Message {
    ...
    /* loaded from: classes2.dex */
    public static final class Builder extends Message.Builder<PubMatchCardInfo> {
        ...
        public Builder(PubMatchCardInfo pubMatchCardInfo) {
            super(pubMatchCardInfo);
            if (pubMatchCardInfo == null) {
                return;
            }
            this.name = pubMatchCardInfo.name;
            this.status = pubMatchCardInfo.status;
            this.card_title = pubMatchCardInfo.card_title;
            this.topic_id = pubMatchCardInfo.topic_id;
            this.team_name_a = pubMatchCardInfo.team_name_a;
            this.team_name_b = pubMatchCardInfo.team_name_b;
            this.team_icon_a = pubMatchCardInfo.team_icon_a;
            this.team_icon_b = pubMatchCardInfo.team_icon_b;
            this.start_desc = pubMatchCardInfo.start_desc;
            this.team_score_a = pubMatchCardInfo.team_score_a;
            this.team_score_b = pubMatchCardInfo.team_score_b;
            this.thread_list = Message.copyOf(pubMatchCardInfo.thread_list);
            this.icon_text = pubMatchCardInfo.icon_text;
        }

        /* JADX DEBUG: Method merged with bridge method */
        @Override // com.squareup.wire.Message.Builder
        public PubMatchCardInfo build(boolean z) {
            return new PubMatchCardInfo(this, z);
        }
    }

    public PubMatchCardInfo(Builder builder, boolean z) {
        super(builder);
        if (z) {
