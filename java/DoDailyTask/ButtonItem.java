...
public final class ButtonItem extends Message {
    ...
    public static final class Builder extends Message.Builder<ButtonItem> {
        ...
        public ButtonItem build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new ButtonItem(this, z, null) : (ButtonItem) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ ButtonItem(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
