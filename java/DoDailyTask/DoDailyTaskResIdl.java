...
public final class DoDailyTaskResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<DoDailyTaskResIdl> {
        ...
        public Builder(DoDailyTaskResIdl doDailyTaskResIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {doDailyTaskResIdl};
        ...
        public DoDailyTaskResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new DoDailyTaskResIdl(this, z, null) : (DoDailyTaskResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ DoDailyTaskResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DoDailyTaskResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
