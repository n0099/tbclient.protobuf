...
public final class GetIconListResIdl extends Message {
    ...
    /* synthetic */ GetIconListResIdl(Builder builder, boolean z, GetIconListResIdl getIconListResIdl) {
        this(builder, z);
    }
    ...
    /* loaded from: classes.dex */
    public final class Builder extends Message.Builder<GetIconListResIdl> {
        public DataRes data;
        public Error error;
        ...
        public GetIconListResIdl build(boolean z) {
            return new GetIconListResIdl(this, z, null);
        }
    }
}
