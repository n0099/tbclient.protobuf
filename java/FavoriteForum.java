...
public final class FavoriteForum extends Message {
    ...
    public final class Builder extends Message.Builder {
        ...
        public FavoriteForum build(boolean z) {
            ...
            if (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) {
                return new FavoriteForum(this, z, null);
            }
            return (FavoriteForum) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ FavoriteForum(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
}
