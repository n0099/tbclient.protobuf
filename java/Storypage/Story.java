...
public final class Story extends Message {
    ...
    public static final class Builder extends Message.Builder<Story> {
        ...
        public Story build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new Story(this, z, null) : (Story) invokeZ.objValue;
        }
    }
