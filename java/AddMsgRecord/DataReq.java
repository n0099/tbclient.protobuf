...
public final class DataReq extends Message {
    ...
    public static final List<MsgRecord> DEFAULT_RECORDS;
    public transient /* synthetic */ FieldHolder $fh;
    @ProtoField(tag = 1)

    /* renamed from: common  reason: collision with root package name */
    public final CommonReq f79873common;
    ...
    public static final class Builder extends Message.Builder<DataReq> {
        ...
        public Builder(DataReq dataReq) {
            ...
            this.f79874common = dataReq.f79873common;
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(560375899, "Ltbclient/AddMsgRecord/DataReq;")) != null) {
        ...
        DEFAULT_RECORDS = Collections.emptyList();
    }
    ...
    public DataReq(Builder builder, boolean z) {
        ...
        if (z) {
            this.f79873common = builder.f79874common;
