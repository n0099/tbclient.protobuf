...
public final class RecommforumResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<RecommforumResIdl> {
        ...
        public Builder(RecommforumResIdl recommforumResIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {recommforumResIdl};
        ...
        public RecommforumResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new RecommforumResIdl(this, z, null) : (RecommforumResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ RecommforumResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RecommforumResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
