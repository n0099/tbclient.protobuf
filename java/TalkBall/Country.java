...
public final class Country extends Message {
    ...
    public static final class Builder extends Message.Builder<Country> {
        ...
        public Country build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new Country(this, z, null) : (Country) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ Country(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
