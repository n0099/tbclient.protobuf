...
public final class VideoCard extends Message {
    ...
    public static final class Builder extends Message.Builder<VideoCard> {
        ...
        public VideoCard build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new VideoCard(this, z, null) : (VideoCard) invokeZ.objValue;
        }
    }
