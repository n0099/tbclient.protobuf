...
public final class ReportType extends Message {
    ...
    public static final class Builder extends Message.Builder<ReportType> {
        ...
        public ReportType build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new ReportType(this, z, null) : (ReportType) invokeZ.objValue;
        }
    }
