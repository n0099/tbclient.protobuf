...
public final class DataRes extends Message {
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(-691881788, "Ltbclient/VoiceRoomListPage/DataRes;")) != null) {
    ...
    public DataRes(Builder builder, boolean z) {
        ...
        if (z) {
            List list = builder.voice_room_list;
            if (list == null) {
