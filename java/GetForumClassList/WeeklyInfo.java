...
public final class WeeklyInfo extends Message {
    ...
    public static final class Builder extends Message.Builder<WeeklyInfo> {
        ...
        public WeeklyInfo build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new WeeklyInfo(this, z, null) : (WeeklyInfo) invokeZ.objValue;
        }
    }
    ...
    static {
        ...
        if (classClinitInterceptable != null && (invokeClinit = classClinitInterceptable.invokeClinit(1865638782, "Ltbclient/GetForumClassList/WeeklyInfo;")) != null) {
    ...
    public /* synthetic */ WeeklyInfo(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
