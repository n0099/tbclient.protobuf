...
public final class RecommendFriendReqIdl extends Message {
    ...
    /* synthetic */ RecommendFriendReqIdl(Builder builder, boolean z, RecommendFriendReqIdl recommendFriendReqIdl) {
        this(builder, z);
    }
    ...
    /* loaded from: classes.dex */
    public final class Builder extends Message.Builder<RecommendFriendReqIdl> {
        public ReqData data;
        ...
        public RecommendFriendReqIdl build(boolean z) {
            return new RecommendFriendReqIdl(this, z, null);
        }
    }
}
