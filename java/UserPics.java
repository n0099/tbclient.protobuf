...
public final class UserPics extends Message {
    ...
    public static final class Builder extends Message.Builder<UserPics> {
        ...
        public UserPics build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new UserPics(this, z, null) : (UserPics) invokeZ.objValue;
        }
    }
