...
public final class ItemPlot extends Message {
    ...
    public static final class Builder extends Message.Builder<ItemPlot> {
        ...
        public ItemPlot build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new ItemPlot(this, z, null) : (ItemPlot) invokeZ.objValue;
        }
    }
