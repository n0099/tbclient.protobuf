...
public final class SkinInfo extends Message {
    ...
    public static final class Builder extends Message.Builder<SkinInfo> {
        ...
        public SkinInfo build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new SkinInfo(this, z, null) : (SkinInfo) invokeZ.objValue;
        }
    }
