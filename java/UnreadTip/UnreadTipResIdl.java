...
public final class UnreadTipResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<UnreadTipResIdl> {
        ...
        public UnreadTipResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new UnreadTipResIdl(this, z, null) : (UnreadTipResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ UnreadTipResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UnreadTipResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
