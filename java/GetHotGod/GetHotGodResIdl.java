...
public final class GetHotGodResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<GetHotGodResIdl> {
        ...
        public GetHotGodResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new GetHotGodResIdl(this, z, null) : (GetHotGodResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ GetHotGodResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GetHotGodResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
