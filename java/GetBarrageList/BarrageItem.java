...
public final class BarrageItem extends Message {
    ...
    public static final class Builder extends Message.Builder<BarrageItem> {
        ...
        public BarrageItem build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new BarrageItem(this, z, null) : (BarrageItem) invokeZ.objValue;
        }
    }
