...
public final class HighCover extends Message {
    ...
    public static final class Builder extends Message.Builder<HighCover> {
        ...
        public HighCover build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new HighCover(this, z, null) : (HighCover) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ HighCover(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
