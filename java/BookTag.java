...
public final class BookTag extends Message {
    ...
    public static final class Builder extends Message.Builder<BookTag> {
        ...
        public BookTag build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new BookTag(this, z, null) : (BookTag) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ BookTag(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
