...
public final class GodThreadListResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<GodThreadListResIdl> {
        ...
        public Builder(GodThreadListResIdl godThreadListResIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {godThreadListResIdl};
        ...
        public GodThreadListResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new GodThreadListResIdl(this, z, null) : (GodThreadListResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ GodThreadListResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GodThreadListResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
