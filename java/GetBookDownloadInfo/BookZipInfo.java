...
public final class BookZipInfo extends Message {
    ...
    public static final class Builder extends Message.Builder<BookZipInfo> {
        ...
        public BookZipInfo build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new BookZipInfo(this, z, null) : (BookZipInfo) invokeZ.objValue;
        }
    }
