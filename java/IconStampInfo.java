...
public final class IconStampInfo extends Message {
    ...
    public static final class Builder extends Message.Builder<IconStampInfo> {
        ...
        public IconStampInfo build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new IconStampInfo(this, z, null) : (IconStampInfo) invokeZ.objValue;
        }
    }
