...
public final class UserlikeResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<UserlikeResIdl> {
        ...
        public UserlikeResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new UserlikeResIdl(this, z, null) : (UserlikeResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ UserlikeResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
