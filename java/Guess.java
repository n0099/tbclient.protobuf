...
public final class Guess extends Message {
    ...
    public static final class Builder extends Message.Builder<Guess> {
        ...
        public Guess build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new Guess(this, z, null) : (Guess) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ Guess(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
