...
public final class AddLotteryCountResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<AddLotteryCountResIdl> {
        ...
        public Builder(AddLotteryCountResIdl addLotteryCountResIdl) {
            ...
            if (interceptable != null) {
                ...
                Object[] objArr = {addLotteryCountResIdl};
        ...
        public AddLotteryCountResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new AddLotteryCountResIdl(this, z, null) : (AddLotteryCountResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ AddLotteryCountResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AddLotteryCountResIdl(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
