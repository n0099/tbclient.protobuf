...
public final class SelectInterest extends Message {
    ...
    public static final class Builder extends Message.Builder<SelectInterest> {
        ...
        public SelectInterest build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new SelectInterest(this, z, null) : (SelectInterest) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ SelectInterest(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SelectInterest(Builder builder, boolean z) {
        super(builder);
        Interceptable interceptable = $ic;
        if (interceptable != null) {
            InitContext newInitContext = TitanRuntime.newInitContext();
        ...
        if (z) {
            String str = builder.select_interest_name;
            if (str == null) {
                this.select_interest_name = "";
                return;
            } else {
                this.select_interest_name = str;
                return;
            }
        }
