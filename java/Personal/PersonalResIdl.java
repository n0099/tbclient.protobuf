...
public final class PersonalResIdl extends Message {
    ...
    public static final class Builder extends Message.Builder<PersonalResIdl> {
        ...
        public PersonalResIdl build(boolean z) {
            ...
            Interceptable interceptable = $ic;
            return (interceptable == null || (invokeZ = interceptable.invokeZ(Constants.METHOD_GET_CONTACTER_INFO_FOR_SESSION, this, z)) == null) ? new PersonalResIdl(this, z, null) : (PersonalResIdl) invokeZ.objValue;
        }
    }
    ...
    public /* synthetic */ PersonalResIdl(Builder builder, boolean z, a aVar) {
        this(builder, z);
    }
